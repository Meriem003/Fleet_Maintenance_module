...
export const EditMaintenanceModal = ({ isOpen, onClose, maintenance, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || 'Échec de la mise à jour de la maintenance');
    } finally {
      setLoading(false);
    }
  };
